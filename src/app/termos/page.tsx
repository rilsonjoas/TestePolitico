...
export const metadata: Metadata = {
  title: "Termos de Uso | Teste Político 8 Valores",
  description: "Termos de Uso do Teste Político 8 Valores",
};
    ...
    <main className="min-h-screen w-full flex flex-col items-center px-4 py-8">
      <div className="w-full max-w-3xl bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 md:p-10">
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            Ao acessar e utilizar o <strong>Teste Político 8 Valores</strong>, você concorda com
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            O Teste Político 8 Valores é uma ferramenta educacional e de entretenimento que permite
