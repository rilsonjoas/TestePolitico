...
import { CheckCircle2, BookOpen, Scale, CircleDollarSign, Globe, Landmark } from "lucide-react";
      ...
      <div className="space-y-12">
        ...
        <section className="bg-white dark:bg-gray-800 rounded-2xl md:rounded-3xl p-5 md:p-8 lg:p-12 shadow-xl border border-gray-100 dark:border-gray-700">
          ...
          <div className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300">
            ...
            <p className="mb-4">
              O teste consiste em <strong>80 perguntas</strong> cuidadosamente selecionadas para avaliar opiniões sobre economia,
