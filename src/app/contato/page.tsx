      ...
      <div className="w-full max-w-2xl text-center space-y-8">
        ...
        <div className="grid gap-6 mt-12 text-left">
          ...
          <a
            ...
            className="group block p-4 md:p-6 bg-white dark:bg-gray-800 rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl border border-gray-100 dark:border-gray-700 transition-all hover:-translate-y-1"
          >
